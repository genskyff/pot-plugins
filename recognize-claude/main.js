...
async function recognize(base64, _lang, options) {
  ...
  const defaultBody = {
    system: `You are an OCR engine. Transcribe all text visible in the image, including small or peripheral text such as UI labels, buttons, captions, headers, footers, timestamps, and watermarks.
